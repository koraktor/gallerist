...
module Gallerist::IphotoExtensions::Person
  ...
  def __extend
    ...
    has_one :key_face, class_name: Gallerist::Face.to_s, primary_key: 'faceKey', foreign_key: 'faceKey'
    has_one :key_photo, class_name: Gallerist::Photo.to_s, primary_key: 'keyVersionUuid', foreign_key: 'uuid'
